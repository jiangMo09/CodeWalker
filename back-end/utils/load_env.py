...
AWS_ALB_ARN = os.getenv("AWS_ALB_ARN")
AWS_ALB_LISTENER_ARN = os.getenv("AWS_ALB_LISTENER_ARN")
AWS_ALB_DNS_NAME = os.getenv("AWS_ALB_DNS_NAME")
AWS_ALB_HOSTED_ZONE_ID = os.getenv("AWS_ALB_HOSTED_ZONE_ID")
AWS_ALB_SECURITY_GROUP_ID = os.getenv("AWS_ALB_SECURITY_GROUP_ID")
